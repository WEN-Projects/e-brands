...
class Accordion {
  ...
  initAccordion(wrapper) {
    ...
    items.forEach(item => {
      ...
      const [head, body] = [this.options.head, this.options.body].map(selector => item.querySelector(selector));
      if (!head || !body) return;
  ...
  toggleContent(item, content) {
    ...
    if (item.classList.contains("opened")) {
      ...
      totalHeight = Array.from(content.children).reduce((sum, child) => sum + child.offsetHeight, totalHeight);
    }

    // Set the height of the content based on the item's state
    content.style.height = item.classList.contains("opened") ? `${totalHeight}px` : null;
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (contentImageTab);

/***/ }),

/***/ "./src/js/components/flexibleContents.js":
/*!***********************************************!*\
  !*** ./src/js/components/flexibleContents.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/components/navigation-toggle.js":
/*!************************************************!*\
  !*** ./src/js/components/navigation-toggle.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   NavigationWithDropdown: () => (/* binding */ NavigationWithDropdown)
/* harmony export */ });
class Navigation {
  constructor(args = {}) {
    this.options = {
  ...
  isMobile() {
    let isMobile = window.matchMedia(`(max-width: ${this.options.breakpoint}px)`).matches;
    window.addEventListener('resize', () => {
      isMobile = window.matchMedia(`(max-width: ${this.options.breakpoint}px)`).matches;
    });
    return isMobile;
  }
  initNavigation() {
    ...
    document.addEventListener('click', e => {
      if (e.target === this.mainNavigation || this.mainNavigation.contains(e.target)) return;
      this.closeMenu();
    });
  }
  toggleMenu() {
...
class NavigationWithDropdown extends Navigation {
  ...
  initDropdownMenu() {
    ...
    this.menuItems = Array.from(this.menu.querySelectorAll('.menu-item-has-children'));
    ...
    this.menuItems.forEach(menuItem => {
      ...
      window.addEventListener('resize', () => this.toggleSubmenuStyle(submenu, menuItem));
      ...
      menuItem.addEventListener('click', e => {
        ...
        if (e.target.tagName === 'A') {
          ...
          if (menuItem.classList.contains('open') && !href.startsWith('#')) {
    ...
    this.menuToggler.addEventListener('click', this.closeDropdownMenu.bind(this));
  ...
  toggleSubmenuStyle(submenu, menuItem) {
    ...
    if (!this.isMobile() && menuItem.parentElement === this.menu) {
      ...
      allSubmenus.forEach(item => {
        ...
        menuPosX > window.innerWidth ? item.classList.add('pos-left') : null;
      });
    }
  }
  ...
  calcSubmenuHeight(submenu) {
    ...
    const height = submenuChildren.reduce((acc, child) => acc + child.offsetHeight, 0);
    return height;
  }
  toggleDropdownMenu(menuItem, submenu) {
    ...
    let siblings = Array.from(menuItem.parentElement.children).filter(item => item !== menuItem && item.classList.contains('open'));
  ...
  toggleSubmenu(isOpen, submenu, siblingMenuItem) {
    ...
    function animateHeight(timestamp) {
      ...
      submenu.style.height = isOpen ? `${heightProgress}px` : `${submenuHeight - heightProgress}px`;
      ...
      if (siblingMenuItem) {
        ...
        siblingsSubmenu.style.height = `${siblingsSubmenuHeight - siblingHeightProgress}px`;
      }
  ...
  closeDeepLevelSubmenus(submenu) {
    ...
    const deepLevelSubmenus = Array.from(submenu.querySelectorAll('ul'));
...
/***/ "./src/js/components/popup-modal.js":
/*!******************************************!*\
  !*** ./src/js/components/popup-modal.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  toTopButton.addEventListener('click', e => {
    ...
    if (smoothScrollSupported) {
      ...
      function slideTop(timestamp) {
        ...
        const scrollProgress = scrollYPos - scrollYPos * Math.min(relativeProgress, 1);

        // update scroll Y position
        window.scroll(0, scrollProgress);

        // call RAF until runtime is less than duration
        if (runtime < duration) window.requestAnimationFrame(slideTop);
      }
...
function scrollToElement(destination, scrollDuration, offset) {
  ...
  if (smoothScrollSupported) {
    ...
    function animateScroll(timestamp) {
      ...
      // Calculate scroll progress of animation relative to duration
      const toScroll = destOffsetTop > scrollYPos ? destOffsetTop - scrollYPos : scrollYPos - destOffsetTop;
      const scrollProgress = destOffsetTop > scrollYPos ? scrollYPos + toScroll * Math.min(relativeProgress, 1) : scrollYPos - toScroll * Math.min(relativeProgress, 1);

      // update scroll Y position
      window.scroll(0, scrollProgress);

      // call RAF until runtime is less than duration
      if (runtime < duration) window.requestAnimationFrame(animateScroll);
    }
...
const Slider = {
  init(options = {}) {
    ...
    this.selector = selector !== null && selector !== void 0 ? selector : '.swiper';
    this.settings = {
      speed: 400,
      spaceBetween: 100,
      slidesPerView: 1,
  ...
  initSliders() {
    ...
    const sliders = Array.from(document.querySelectorAll(this.selector));
  ...
  sliderSettings(selector) {
    ...
    const slider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](selector, this.settings);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _jquery_custom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./jquery/custom */ "./src/js/jquery/custom.js");
/* harmony import */ var _jquery_map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jquery/map */ "./src/js/jquery/map.js");
// import jquery components


function InitJquery() {
  (0,_jquery_custom__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_jquery_map__WEBPACK_IMPORTED_MODULE_1__["default"])();
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (InitJquery);
...
function customJquery() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('document').ready(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('form.product-filter select[name="category"], form.product-filter select[name="brand"]').on('change', function () {
      execute_filter();
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('form.product-filter').on('submit', function (e) {
      e.preventDefault();
      execute_filter();
    });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('span.cl-product-filters').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().next().val('').trigger('change');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('span.cl-product-search-key').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('form.product-filter  #search-results').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div.autocomplete #filter-by-search_key').val('').trigger('change');
    execute_filter();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.e-brands-pagination a', function (e) {
    e.preventDefault();
    let hrfe_link = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href') == '' ? ebrands_obj.ebrands_shop_url : jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).prop('href');
    window.history.pushState({}, '', hrfe_link);
    applyAjaxFilter(hrfe_link);
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('form.product-filter input[name="search_key"]').on("keyup", function () {
    let selected_cat = jquery__WEBPACK_IMPORTED_MODULE_0___default()('form.product-filter select[name="category"]').val();
    let selected_brand = jquery__WEBPACK_IMPORTED_MODULE_0___default()('form.product-filter select[name="brand"]').val();
    let search_key = jquery__WEBPACK_IMPORTED_MODULE_0___default()('form.product-filter input[name="search_key"]').val();
  });
  ...
  function updateUrlParameter(url, params) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().each(params, function (index, val) {
  ...
  function updateTheListingTitle() {
    let title_arr = [];
    let search_keyword = jquery__WEBPACK_IMPORTED_MODULE_0___default()("form.product-filter input[name='search_key']").val();
    let selected_brand = jquery__WEBPACK_IMPORTED_MODULE_0___default()("form.product-filter select[name='brand']").find(":selected").val();
    let selected_cat = jquery__WEBPACK_IMPORTED_MODULE_0___default()("form.product-filter select[name='category']").find(":selected").val();
    if ('undefined' != typeof search_keyword && '' != search_keyword) {
      title_arr.push(search_keyword);
    }
    if ('undefined' != typeof selected_brand && '' != selected_brand) {
      let selected_brand_label = jquery__WEBPACK_IMPORTED_MODULE_0___default()("form.product-filter select[name='brand']").find(":selected").text();
      title_arr.push(selected_brand_label);
    }
    if ('undefined' != typeof selected_cat && '' != selected_cat) {
      let selected_cat_label = jquery__WEBPACK_IMPORTED_MODULE_0___default()("form.product-filter select[name='category']").find(":selected").text();
      title_arr.push(selected_cat_label);
    }
    if (title_arr.length !== 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#product-listing-title").html(title_arr.join(' / '));
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#product-listing-title").html("Highlights");
    }
  }
  function applyAjaxFilter(reqURL, restForm = false) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      beforeSend: function beforeSend() {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('section.product-list').addClass('loading');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('form.product-filter  #search-results').hide();
      },
      success: function success(response) {
        var listingContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()(response).find('#ebrands-shop-product-list').html();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#ebrands-shop-product-list').html(listingContent);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('section.product-list').removeClass('loading');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function ($) {
    if ('undefined' != typeof ebrands_obj.selected_event_category && '' != ebrands_obj.selected_event_category) {
      $('html, body').animate({
        scrollTop: $('#ebrands-events-listing').offset().top - 320
      }, 800);
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (customJquery);

/***/ }),

/***/ "./src/js/jquery/map.js":
/*!******************************!*\
  !*** ./src/js/jquery/map.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (mapJquery);
...
/* harmony import */ var _components_navigation_toggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/navigation-toggle */ "./src/js/components/navigation-toggle.js");
...
/* harmony import */ var _components_content_image_tab__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/content-image-tab */ "./src/js/components/content-image-tab.js");
...
/* harmony import */ var _components_autocomplete__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/autocomplete */ "./src/js/components/autocomplete.js");
/* harmony import */ var _components_popup_modal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/popup-modal */ "./src/js/components/popup-modal.js");
...
const Init = {
  commonJS() {
     ...
     * @param {number} [showOnSCroll=200] - The Scroll value from top to show the button.
     */
    (0,_components_scroll__WEBPACK_IMPORTED_MODULE_0__.ScrollToTop)('.to-top', 1500, 72);
     ...
     */
    (0,_components_scroll__WEBPACK_IMPORTED_MODULE_0__.SmoothScroll)();
    ...
    (0,_components_navigation_toggle__WEBPACK_IMPORTED_MODULE_2__.Megamenu)();

    // If menu have no dropdown, use only Navigation else use NavigationWithDropdown
    // const nav = new Navigation();
    const navWithDropdown = new _components_navigation__WEBPACK_IMPORTED_MODULE_1__.NavigationWithDropdown();
    ...
    (0,_components_content_image_tab__WEBPACK_IMPORTED_MODULE_4__["default"])();
    _components_sliders__WEBPACK_IMPORTED_MODULE_3__.Slider.init({
    ...
    new _components_accordion__WEBPACK_IMPORTED_MODULE_5__["default"]({
    ...
    (0,_components_popup_modal__WEBPACK_IMPORTED_MODULE_7__["default"])();
  },
  banner() {},
  slider() {},
  accordions() {
  ...
  //To reset fields on the shop page filter
  autoComplete() {
    (0,_components_autocomplete__WEBPACK_IMPORTED_MODULE_6__["default"])();
  }
};
...
/* harmony import */ var _js_components_flexibleContents__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/components/flexibleContents */ "./src/js/components/flexibleContents.js");
/* harmony import */ var _js_custom_jquery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/custom-jquery */ "./src/js/custom-jquery.js");
...
// Execute common JS
_js_main__WEBPACK_IMPORTED_MODULE_0__["default"].commonJS();

// Loop through each Function in Init
for (const section in _js_main__WEBPACK_IMPORTED_MODULE_0__["default"]) {
  // Check if the section function is direct property of the Init object
  if (_js_main__WEBPACK_IMPORTED_MODULE_0__["default"].hasOwnProperty(section)) {
    // Execute section function only if the section is on the page
    if (_js_components_flexibleContents__WEBPACK_IMPORTED_MODULE_1__["default"].includes(section)) {
      _js_main__WEBPACK_IMPORTED_MODULE_0__["default"][section]();
    }
  }
}
(0,_js_custom_jquery__WEBPACK_IMPORTED_MODULE_2__["default"])();
})();
